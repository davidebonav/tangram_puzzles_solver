...
const char *insert_solutions_sql = "INSERT INTO solutions(puzzle_id, piece_id, piece_coordinates) VALUES \
      (1,1,'POLYGON((0 0, 0.5 0.5, 1 0, 0 0))'), \
      (1,2,'POLYGON((0.75 0.25, 0.25 0.75, 0.75 1.25, 0.75 0.25))'), \
      (1,3,'POLYGON((1.25 1.25, 0.75 1.25, 0.75 0.75, 1.25 1.25))'), \
      (1,4,'POLYGON((0.5 1, 0 1, 0.25 0.75, 0.5 1))'), \
      (1,5,'POLYGON((0.75 0.75, 0.75 0.25, 1 0.5, 0.75 0.75))'), \
      (1,6,'POLYGON((0 0.5, 0.25 0.75, 0.5 0.5, 0.25 0.25, 0 0.5))'), \
      (1,7,'POLYGON((-0.25 1.25, 0.25 1.25, 0.5 1, 0 1, -0.25 1.25))');";
