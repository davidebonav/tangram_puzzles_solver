...
const char *insert_solutions_sql = "INSERT INTO solutions(puzzle_id, piece_id, piece_coordinates) VALUES \
      ...
      (3,2,'POLYGON((1.23 1.24, 0.53 1.24, 0.53 0.53, 1.23 1.24))'), \
      (3,3,'POLYGON((1.06 0, 0.70 0.35, 0.35 0, 1.06 0))'), \
      (3,4,'POLYGON((0.78 0.78, 1.03 0.53, 0.53 0.53, 0.78 0.78))'), \
      (3,5,'POLYGON((0.78 0.28, 1.03 0.53, 0.53 0.53, 0.78 0.28))'), \
      (3,6,'POLYGON((0.02 0.53, 0.27 0.78, 0.53 0.53, 0.27 0.28,0.02 0.53))'), \
