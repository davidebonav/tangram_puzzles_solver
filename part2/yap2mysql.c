...
static bool finish_with_error(MYSQL*); 
...
void init_predicates() {
    ...
    YAP_UserBackCutCPredicate("db_row", c_db_row_start, c_db_row_continue, c_db_row_cut, 2, 1);
...
static int c_db_connect(void) {
    ...
    snprintf(
        ...
        "user=%s password=%s dbname=%d host=%s", 
